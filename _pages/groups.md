...
> 선배들은 우선 이상한 비교를 하지 말라고 화를 냈다. 그리고 업무를 AI에 의존하고 자기 전문성이 없는 변호사가 어떻게 훌륭한 변호사라고 할 수 있겠냐며 반문했다.
...
>
> AI 전문가 대체론에 대한 생각
> AI가 전문가를 대체할 수 있다는 주장은 어쩌면 '콘텐츠 기반'의 영역에서만 타당할 수 있을지 모른다. AI가 잘 작성한 95점짜리 콘텐츠를 고객이 그대로 활용하는 것이라면, 시간과 비용을 아낄 수 있는 AI를 선택하지 않을 이유가 없다. 그러나 이는 고객과의 소통, 제3자 설득, 즉흥적 판단 등 전문가가 사람으로서 직접 개입해야 하는 영역에서는 이야기가 달라진다. 이 경우 고객이 전문가를 선택하는 기준은 단순히 '답이 맞느냐'를 넘어, '내 일을 믿고 맡길 수 있는가'라는 신뢰로 쏠리게 된다. 그리고 그 신뢰는 깊은 역량과 오랜 경험을 가진 사람에게서만 나올 수 있다. 결국 AI는 '사람으로서의 전문가'를 대체할 수 없다.
>
> 공부하지 않아도 되는 시대가 아닌, '더 넓게' 공부해야 하는 시대
> 누군가는 AI가 있으니 전문가는 이제 더 이상 예전처럼 열심히 공부할 필요가 없다고 말한다. 그리고 이제는 커뮤니케이션 기술을 키워야 한다고 말한다. 그러나 이는 반은 맞고 반은 틀린 이야기다(커뮤니케이션 기술을 키워야 한다는 점에는 동의한다). AI라는 강력한 도구가 생겼기에, 우리는 오히려 더 효율적이고 광범위하게 공부해야 한다.
>
...
### 09-Jan-2026 - K-PAI meets SNU College of Engineering! :)
