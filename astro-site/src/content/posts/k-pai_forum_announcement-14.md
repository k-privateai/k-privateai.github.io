...
title: >-
  K-PAI's 14th Chapter: 2026 New Year Celebration - Reflecting, Connecting, and
  Celebrating!
categories:
  - blog
tags:
...
toc_sticky: true
author_profile: true
_legacyPermalink: /event-announcements/14
slug: k-pai_forum_announcement-14
---
...
Use this link
&ndash; <a href="<!-- TODO: LIQUID {{ page.url }} -->"><!-- TODO: LIQUID {{ page.url }} --></a> &ndash;
...
**What to donate:** Gift cards, tech accessories, books, K-PAI branded items, wine/spirits, gourmet food baskets, experience vouchers, subscription services—anything that would delight a winner!
...
## Vision 2026 - K-PAI's Strategic Direction (6:45pm ~ 7pm)
...
## The First Annual [K-PAI](/) Community Awards! 🏆 (7:15pm ~ 7:30pm)
...
<!--span style="color: red;">Congratulations to all winners—and thank you to every member whose participation makes <a href="/">K-PAI</a> extraordinary!</span-->

## The [K-PAI](/) Community Auction! 🎨 (7:30pm ~ 8pm)
